...
export default function Nav({ show }) {
  ...
  const activeLink = 'flex items-center gap-2 rounded-lg bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700';
      ...
      <div className="px-4  py-6">
        ...
        <ul className="mt-6 space-y-1">
          <li>
            <Link
              href=""
              className="flex items-center gap-2 rounded-lg bg-gray-100 px-4 py-2 text-gray-500"
            >
